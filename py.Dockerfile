...
# docker run --rm --env-file .env -e DATABASE_URL=postgresql://postgres:postgreses@host.docker.internal:5432/postgres -e BROKER_URL=redis://host.docker.internal:6379/0 emailwise-generator:latest celery -A tasks worker --loglevel=INFO